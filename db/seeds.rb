...
if Rails.env.development?
  ...
  # Question
  Question.find_or_create_by(content: '마무리')
  Question.find_or_create_by(content: '꿈')
  Question.find_or_create_by(content: '쿵따리')
  Question.find_or_create_by(content: '샤바라')
  Question.find_or_create_by(content: '빠빠빠')
  Question.find_or_create_by(content: '탐사수')
  Question.find_or_create_by(content: '삼다수')
  Question.find_or_create_by(content: '나띵북')
  Question.find_or_create_by(content: '피카츄')
  Question.find_or_create_by(content: '라이츄')
  Question.find_or_create_by(content: '파이리')
  ...
  Post.find_or_create_by(author_id: 2, content: '언녜~!!!')
  Post.find_or_create_by(author_id: 2, content: '깔깔깔')
  Post.find_or_create_by(author_id: 2, content: '알지알지~~~')
  Post.find_or_create_by(author_id: 2, content: '갠찬타 갠찬타~~')
  Post.find_or_create_by(author_id: 2, content: '아이 증말')
  Post.find_or_create_by(author_id: 2, content: '언니~!')
  Post.find_or_create_by(author_id: 7, content: 'ㅎㅇㅎㅇ')
  Post.find_or_create_by(author_id: 7, content: '익명피드')
  Post.find_or_create_by(author_id: 7, content: '테스트')
  Post.find_or_create_by(author_id: 7, content: '졸라리')
  Post.find_or_create_by(author_id: 7, content: '귀찮아')
  Post.find_or_create_by(author_id: 7, content: '모든건')
  Post.find_or_create_by(author_id: 7, content: '손으로')
  Post.find_or_create_by(author_id: 7, content: '한땀한땀')
  Post.find_or_create_by(author_id: 7, content: '왜냐')
  Post.find_or_create_by(author_id: 7, content: '무식하거든')
  Post.find_or_create_by(author_id: 7, content: '낄낄')
  Post.find_or_create_by(author_id: 7, content: '언젠간')
  Post.find_or_create_by(author_id: 7, content: '20개를')
  Post.find_or_create_by(author_id: 7, content: '넘어갈 수 있을거야')
  Post.find_or_create_by(author_id: 7, content: '힘을 내')
  Post.find_or_create_by(author_id: 7, content: '제발~')
  Post.find_or_create_by(author_id: 7, content: '아휴')
  Post.find_or_create_by(author_id: 7, content: '곧')
  Post.find_or_create_by(author_id: 7, content: '되겠지')
  Post.find_or_create_by(author_id: 7, content: '아 지루해')
  Post.find_or_create_by(author_id: 7, content: '이거')
  Post.find_or_create_by(author_id: 7, content: 'for loop')
  Post.find_or_create_by(author_id: 7, content: '으로 했으면')
  Post.find_or_create_by(author_id: 7, content: '금방 했겠지만')
  Post.find_or_create_by(author_id: 7, content: '지금은')
  Post.find_or_create_by(author_id: 7, content: '그걸 할 수')
  Post.find_or_create_by(author_id: 7, content: '없을만큼')
  Post.find_or_create_by(author_id: 7, content: '머리가')
  Post.find_or_create_by(author_id: 7, content: '돌아가지')
  Post.find_or_create_by(author_id: 7, content: '않는다')
  Post.find_or_create_by(author_id: 7, content: '이 정도면 충분할듯!')
  Post.find_or_create_by(author_id: 7, content: '이 정도면 충분할듯!')
  ...
  # Custom Question
  CustomQuestion.find_or_create_by(author_id: 1, content: "what?")
